...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/bin/open-workspace.sh"))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + J", hl.dsp.layout("togglesplit")) -- dwindle only
hl.bind(mainMod .. " + SHIFT + F", hl.dsp.exec_cmd("firefox"))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("~/games/jagex.AppImage"))
...
-- Laptop multimedia keys for volume and LCD brightnesshl.bind(mainMod .. " + F", hl.dsp.exec_cmd("Firefox"))
